  ...
  sections: [
    {
      ...
      chapters: [
        ...
        },
        {
          ...
          icon: '⚡',
          intro: 'Astrophage captures 585 nm light and stores it as chemical bonds at an efficiency ~20× greater than nuclear fission. Press play to watch the full conversion cycle: incoming photon, charged vacuole, reproduction.',
          note: {
        ...
        },
        {
          ...
          icon: '🌍',
          intro: 'Astrophage is fiction. The science it\'s built on isn\'t. Real organisms on Earth have evolved analogous strategies for surviving extreme environments and extracting unusual energy. Explore four real-world parallels.'
        },
        {
          id: 'petrova',
          ...
          icon: '★',
          intro: 'When a colony grows large enough, it visibly dims its host star, creating the "Petrova line." Drag the slider to see how even a tiny coverage fraction translates into an almost incomprehensible energy drain.'
        },
        {
          id: 'taumoeba',
          shortLabel: 'Taumoeba',
      ...
      chapters: [
        ...
        },
        {
          ...
          note: {
            ...
            text: 'Weir does not resolve the ethical tension he creates. Stratt is portrayed as correct in outcome and monstrous in method. The novel asks whether that distinction matters. It doesn\'t answer.'
          }
        },
        {
          id: 'grace-scientist',
      ...
      chapters: [
        {
          ...
          icon: '◉',
          intro: 'Gargantua is 100 million solar masses, spinning at near-maximum rate. Physicist Kip Thorne derived the correct equations for its visual appearance. The rendering was accurate enough to produce two unexpected scientific papers. Click each element of the black hole to explore the physics behind it.',
          stats: [
    ...
    },
    {
      ...
      chapters: [
        ...
        },
        {
          ...
          icon: '⬡',
          intro: "The film's climax places Cooper inside a five-dimensional structure where time is a spatial dimension he can physically traverse. Explore how dimensions build on each other: line, plane, 3D space, Einstein's 4D spacetime, and finally the fifth dimension the bulk beings inhabit.",
          note: {
            label: 'The Block Universe',
            text: "Einstein's relativity implies that past, present, and future all coexist in a four-dimensional block. The 'bulk beings' exist in five dimensions and can step through time the way we step across a room."
          }
        }
      ]
    },
      ...
      chapters: [
        {
          ...
          icon: '◌',
          intro: "The Lazarus missions surveyed twelve worlds beyond the wormhole. Three sent back promising signals. Each is a case study in how physics, orbital mechanics, and proximity to a supermassive black hole create entirely alien environments with entirely different fates.",
          stats: [
